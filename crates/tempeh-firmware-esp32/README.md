...
This firmware does not actuate the heater yet. It reports the heater decision it would make as `control,...` rows.
...
The firmware-side `control,...` rows are diagnostic only until a heater adapter is added.
